...
{
        public static function query($viewType, $constraint = "2=2")
        {
    global $auth;
    ...
    switch($viewType)
    {
        ...
        case Settings::ASSEARCHLIST:
                        return "SELECT id, name AS label FROM suites WHERE $constraint ORDER BY name";
    }
        }
        ...
        {
            return parent::references("suites");
        }
