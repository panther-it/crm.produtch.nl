    ...
    switch($viewType)
    {
        ...
        case Settings::ASSEARCH:
                        return "SELECT p.owner
                                     ...
                                     , p.label
                                     , p.info_uri
                                     , replace(p.recap_uri, 'http://www.redunix.nl','') as recap_uri
                                     , replace(replace(replace(p.recap_uri,'http://www.redunix.nl',''),'/webparts/block_','/img/'),'.html','.jpg') as thumb
                                     , ''         as highlight
                                     , 'Vandaag'  as deliverable 
                                     , p.enabled
                                     , p.type
                                     , p.recurring
                                     , p.price_1
