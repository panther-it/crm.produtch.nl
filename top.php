<? require_once(__DIR__ . "/webparts/header.php") ?>
  <div id='main'>
    ...
    <div id='wide'>
      <div id='menu'>
        <div id='menu_left'> 
		<img height="55" style="margin-top: -20px; margin-left: -10px;" src="http://www.redunix.panther-it.nl/img/logo.jpg" />
        </div>

        <div id='menu_right'>
	<table border="0" style="margin-top: -12px" ><tr><td style="width: 320px;">
          <p style="margin-top: -4px;">
              <a href='/tables/'          target="mainFrame"
                 onClick="document.getElementById('tablesMenu').style.display='block'; document.getElementById('appsMenu').style.display='none'; return false;">Data Tables</a>...
	  </p>
          ...
          <p style="margin-top: 5px;">
             <a href="/apps/"            target="mainFrame"
                 onClick="document.getElementById('appsMenu').style.display='block'; document.getElementById('tablesMenu').style.display='none'; return false;">Applications</a>...
          </p>
