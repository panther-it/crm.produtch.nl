...
<?
        ...
        //if ($auth->allowed("stats_colo" ))   { block("http://dataverkeer.produtch.nl/index","Server Statistieken","dataverkeer" ); }
        //if ($auth->allowed("monitoring" ))   { block("http://monitoring.producht.nl/index" ,"Server Monitoring"  ,"monitoring"  ); } 
        //if ($auth->allowed("backup"     ))   { block("http://backup.produtch.nl/index" ,"Backups (gfx)"      ,"backup-gfx"  ); }
